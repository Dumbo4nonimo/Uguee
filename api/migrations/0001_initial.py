    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(validators=[api.validators.length_limit]),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(
                        max_length=20, validators=[api.validators.is_numeric]
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=10,
                        unique=True,
                        validators=[api.validators.is_numeric],
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            api.validators.validate_7_characters,
                            api.validators.is_numeric,
                        ],
                    ),
                ),
                (
                    "faculty",
                    models.CharField(
                        max_length=100, validators=[api.validators.is_numeric]
                    ),
                ),
                (
                    "degree",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "travel_fk",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="api.travel"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("comment", models.TextField(validators=[api.validators.length_limit])),
